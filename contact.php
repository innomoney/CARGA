<?php
include '../CARGA/validate/contact-inc.php';
?>

<!DOCTYPE html>
<html>

<!-- Mirrored from nauthemes.net/html/carga/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 May 2022 14:22:12 GMT -->
<head>
<meta charset="utf-8">
<title>Carga HTML Template | Contact</title>
<!-- Stylesheets -->
				...
				<div class="header-upper">
					...
					<div class="clearfix">
						...
						<div class="pull-left logo-box">
							<div class="logo"><a href="contact.php"><img src="images/logo-2.png" alt="" title=""></a></div>
						</div>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="contact.php" class="img-responsive"><img src="images/logo-small-2.png" alt="" title=""></a>
                </div>
				...
				<form method="post" action="">
					<div class="row clearfix">
						...
						<div class="form-group col-lg-6 col-md-6 col-sm-12">
							<button type="submit" name="submit" class="theme-btn btn-style-one">Request a Quote / Give Feedback</button>
						</div>
					</div>
				</form>
			</div>
			...
			<div class="clearfix">
				...
				<div class="left-column" style="background-image:url(images/background/5.jpg)">
					<div class="inner-column">
						...
						<a href="services.php" class="theme-btn btn-style-one">Check Packages</a>
					</div>
				</div>
                                ...
                                <div class="footer-widget mail-widget">
									...
									<?php
											if(isset($_POST['emailcontact'])){
												...
												$new_contact = filter_var($contact,  FILTER_SANITIZE_EMAIL);
												...
												}elseif(!filter_var($new_contact, FILTER_VALIDATE_EMAIL)){
													echo '<script>
												...
												window.location = "contact.php";
													...
													$sql = "insert into `contactemail`(email) values ('$new_contact')";
										...
										<form method="post" action="">
											<div class="form-group clearfix">
												<input type="email" name="contact" value="" placeholder="Email address">
												<button type="submit" name="emailcontact" class="theme-btn submit-btn"><span class="icon fa fa-check"></span></button>
											</div>
										</form>
									</div>
