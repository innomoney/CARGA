...
<!-- Mirrored from nauthemes.net/html/carga/fleet.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 May 2022 14:21:20 GMT -->
<head>
<meta charset="utf-8">
<title>Carga HTML Template | Fleet</title>
<!-- Stylesheets -->
				...
				<div class="header-upper">
					...
					<div class="clearfix">
						...
						<div class="pull-left logo-box">
							<div class="logo"><a href="fleet.php"><img src="images/logo-2.png" alt="" title=""></a></div>
						</div>
										...
										<nav class="main-menu navbar-expand-md">
											...
											<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
												<ul class="navigation clearfix">
													...
													<li class="current"><a href="fleet.php">Our Fleet</a></li>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="fleet.php" class="img-responsive"><img src="images/logo-small-2.png" alt="" title=""></a>
                </div>
		...
		<div class="auto-container">
			<div class="row clearfix">
				...
				<div class="fleet-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="images/resource/fleet-1.jpg" alt="" /></a>
						</div>
				...
				<div class="fleet-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="images/resource/fleet-2.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
				...
				<div class="fleet-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="images/resource/fleet-3.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
				...
				<div class="fleet-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="images/resource/fleet-4.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
				...
				<div class="fleet-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="images/resource/fleet-5.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<h3><a href="#">Air Freight Shipment</a></h3>
							<ul class="fleet-list">
				...
				<div class="fleet-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="images/resource/fleet-6.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<h3><a href="#">Sea Freight Shipment</a></h3>
							<ul class="fleet-list">
				...
				<div class="fleet-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="images/resource/fleet-7.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<h3><a href="#">Truck Freight Shipment</a></h3>
							<ul class="fleet-list">
				...
				<div class="fleet-block col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box">
						<div class="image">
							<a href="#"><img src="images/resource/fleet-8.jpg" alt="" /></a>
						</div>
						<div class="lower-content">
							<h3><a href="#">Truck Freight Shipment</a></h3>
							<ul class="fleet-list">
										...
										<?php
											if(isset($_POST['submit'])){
												...
												window.location = "fleet.php";
													...
													$sql = "insert into `fleet`(email) values ('$new_email')";
...
<!-- Mirrored from nauthemes.net/html/carga/fleet.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 May 2022 14:21:40 GMT -->
</html>