<?php 
include "./validate/quote-inc.php";
?>
<html>
			...
			<div class="quote-form-box">
                ...
                <form method="post" action="">
					<div class="row clearfix">
						...
						<div class="form-group col-lg-4 col-md-6 col-sm-12">
							<label>Phone</label>
							<input type="text" name="phone" placeholder="Your Contact" maxlength="13" minlength="13">
						</div>
						
						<div class="form-group col-lg-4 col-md-6 col-sm-12">
							<label>Transport From</label>
							<select class="custom-select-box" name="transport_from">
						...
						<div class="form-group col-lg-4 col-md-6 col-sm-12">
							...
							<select class="custom-select-box" name="transport_to">
						...
						<div class="form-group col-lg-4 col-md-6 col-sm-12">
							...
							<select class="custom-select-box" name="transport_type">
						...
						<div class="form-group col-lg-4 col-md-6 col-sm-12">
							...
							<select class="custom-select-box" name="package_type">
						...
						<div class="form-group col-lg-2 col-md-6 col-sm-12">
							<label>Weight</label>
							<select class="custom-select-box" name="weight">
						...
						<div class="form-group col-lg-2 col-md-6 col-sm-12">
							<label>Length</label>
							<select class="custom-select-box" name="length">
						...
						<div class="form-group col-lg-2 col-md-6 col-sm-12">
							<label>Range</label>
							<select class="custom-select-box" name="range">
								<option>Normal Range</option>
								<option>Medium Range</option>
								<option>Extended Range</option>
							</select>
						...
						<div class="form-group col-lg-4 col-md-6 col-sm-12">
							...
							<select class="custom-select-box" name="tracking_id">
						...
						<div class="form-group col-lg-4 col-md-6 col-sm-12">
							...
							<select class="custom-select-box" name="packing_type">
						...
						<div class="form-group col-lg-4 col-md-6 col-sm-12">
							...
							<input type="text" name="value" placeholder="In Dollars (USD)">
						</div>

						<input type="hidden" name="track_id">
						
						<div class="form-group col-lg-6 col-md-6 col-sm-12">
							<button type="submit" name="submit" class="theme-btn btn-style-one">Request a Quote</button>
						</div>
				...
				<div class="order-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column" style="background-image:url(images/background/4.png)">
						...
						<div class="track-form">
                            <form method="post" action="./track-trace/track_quote.php">
                                <div class="form-group">
                                    <input type="text" name="track_id" value="" placeholder="Track ID" required>
                                    <button type="submit" class="theme-btn" name="search"><span class="fa fa-search"></span></button>
                                </div>
                            </form>
                        </div>
