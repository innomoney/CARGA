...
<!-- Mirrored from nauthemes.net/html/carga/team-members.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 May 2022 14:22:12 GMT -->
<head>
<meta charset="utf-8">
<title>Carga HTML Template | Team</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
				...
				<div class="header-upper">
					...
					<div class="clearfix">
						...
						<div class="pull-left logo-box">
							<div class="logo"><a href="team-members.php"><img src="images/logo-2.png" alt="" title=""></a></div>
						</div>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="team-members.php" class="img-responsive"><img src="images/logo-small-2.png" alt="" title=""></a>
                </div>
	...
	<section class = "team-section team-list">
       <div class="auto-container">
			<div class="tem-sec">
				<div class="row">
					<div class="col-md-3 col-sm-6 col-lg-3">
						<div class="tm-bx">
							<div class="tm-thmb">
								<a href="#" title="" itemprop="url"><img src="images/clients/38.jpg" alt="Team-Image.jpg" itemprop="image"></a>
								<div class="tm-inf">
					 ...
					 <div class="col-md-3 col-sm-6 col-lg-3">
						<div class="tm-bx">
							<div class="tm-thmb">
								<a href="#" title="" itemprop="url"><img src="images/clients/39.jpg" alt="Team-Image.jpg" itemprop="image"></a>
								<div class="tm-inf">
									<h5 itemprop="headline"><a href="team-detail.html" title="" itemprop="url">Jina Patinson</a></h5>
					 ...
					 <div class="col-md-3 col-sm-6 col-lg-3">
						<div class="tm-bx">
							<div class="tm-thmb">
								<a href="#" title="" itemprop="url"><img src="images/clients/40.jpg" alt="Team-Image.jpg" itemprop="image"></a>
								<div class="tm-inf">
									<h5 itemprop="headline"><a href="team-detail.html" title="" itemprop="url">Mark Hustler</a></h5>
					...
					<div class="col-md-3 col-sm-6 col-lg-3">
						<div class="tm-bx">
							<div class="tm-thmb">
								<a href="#" title="" itemprop="url"><img src="images/clients/41.jpg" alt="Team-Image.jpg" itemprop="image"></a>
								<div class="tm-inf">
					...
					<div class="col-md-3 col-sm-6 col-lg-3">
						<div class="tm-bx">
							<div class="tm-thmb">
								<a href="#" title="" itemprop="url"><img src="images/clients/41.jpg" alt="Team-Image.jpg" itemprop="image"></a>
								<div class="tm-inf">
									<h5 itemprop="headline"><a href="team-detail.php" title="" itemprop="url">John Doe</a></h5>
									<span class ="designation">IT Technician</span>
									<ul class="social-icon-one">
										<li><a href="#"><span class="fa fa-twitter"></span></a></li>
										<li><a href="#"><span class="fa fa-facebook"></span></a></li>
					 ...
					 <div class="col-md-3 col-sm-6 col-lg-3">
						<div class="tm-bx">
							<div class="tm-thmb">
								<a href="#" title="" itemprop="url"><img src="images/clients/40.jpg" alt="Team-Image.jpg" itemprop="image"></a>
								<div class="tm-inf">
									<h5 itemprop="headline"><a href="team-detail.php" title="" itemprop="url">Mark Hustler</a></h5>
									<span class ="designation">Tracking Dept</span>
									<ul class="social-icon-one">
										<li><a href="#"><span class="fa fa-twitter"></span></a></li>
										<li><a href="#"><span class="fa fa-facebook"></span></a></li>
					...
					<div class="col-md-3 col-sm-6 col-lg-3">
						<div class="tm-bx">
							<div class="tm-thmb">
								<a href="#" title="" itemprop="url"><img src="images/clients/38.jpg" alt="Team-Image.jpg" itemprop="image"></a>
								<div class="tm-inf">
									<h5 itemprop="headline"><a href="team-detail.php" title="" itemprop="url">Tim Patinson</a></h5>
									<span class ="designation">Cargo Supervisor</span>
									<ul class="social-icon-one">
										<li><a href="#"><span class="fa fa-twitter"></span></a></li>
										<li><a href="#"><span class="fa fa-facebook"></span></a></li>
					...
					<div class="col-md-3 col-sm-6 col-lg-3">
						<div class="tm-bx">
							<div class="tm-thmb">
								<a href="#" title="" itemprop="url"><img src="images/clients/39.jpg" alt="Team-Image.jpg" itemprop="image"></a>
								<div class="tm-inf">
									<h5 itemprop="headline"><a href="team-detail.php" title="" itemprop="url">Jina Patinson</a></h5>
									<span class ="designation">Shipping Manager</span>
									<ul class="social-icon-one">
										<li><a href="#"><span class="fa fa-twitter"></span></a></li>
										<li><a href="#"><span class="fa fa-facebook"></span></a></li>
									...
									<div class="email-form">
										<?php
											if(isset($_POST['submit'])){
												...
												window.location = "team-members.php";
													...
													$sql = "insert into `team`(email) values ('$new_email')";
										...
										<form method="post" action="">
											<div class="form-group clearfix">
												...
												<button type="submit" name="submit" class="theme-btn submit-btn"><span class="icon fa fa-check"></span></button>
											</div>
										</form>
									</div>
									<div class="text">We respect your privacy</div>
								</div>
							</div>
