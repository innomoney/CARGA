...
<!-- Mirrored from nauthemes.net/html/carga/track-trace/pdo_login.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 May 2022 14:22:11 GMT -->
				...
				<div class="header-upper">
					...
					<div class="clearfix">
						...
						<div class="pull-left logo-box">
							<div class="logo"><a href="pdo_login.php"><img src="../images/logo-2.png" alt="" title=""></a></div>
						</div>
											...
											<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
												<ul class="navigation clearfix">
													...
													<li class="current dropdown"><a href="#">Pages<i class="fa fa-angle-down"></i></a>
														<ul>
															<li class="new-item"><a href="pdo_login.php">Track System <span>(New)</span></a></li>
																...
																<div class="form-container">
																	<form method="post" action="">
																		<div class="form-group">
																			...
																			<button type="submit" name="search" class="search-btn"><span class="fa fa-search"></span></button>
																		</div>
																	</form>
																</div>
															</li>
									...
									<div class="email-form">
										<?php
											if(isset($_POST['logemail'])){
												...
												$new_email_log = filter_var($email_log,  FILTER_SANITIZE_EMAIL);
												...
												}elseif(!filter_var($new_email_log, FILTER_VALIDATE_EMAIL)){
													echo '<script>
												...
												window.location = "pdo_login.php";
													...
													$sql = "insert into `email_log`(email) values ('$new_email_log')";
										...
										<form method="post" action="">
											<div class="form-group clearfix">
												<input type="email" name="email_log" value="" placeholder="Email address">
												<button type="submit" name="logemail" class="theme-btn submit-btn"><span class="icon fa fa-check"></span></button>
											</div>
										</form>
									</div>
