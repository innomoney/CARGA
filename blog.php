...
<!-- Mirrored from nauthemes.net/html/carga/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 May 2022 14:22:12 GMT -->
<head>
<meta charset="utf-8">
<title>Carga HTML Template | Blog Posts</title>
<!-- Stylesheets -->
				...
				<div class="header-upper">
					...
					<div class="clearfix">
						...
						<div class="pull-left logo-box">
							<div class="logo"><a href="blog.php"><img src="images/logo-2.png" alt="" title=""></a></div>
						</div>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="blog.php" class="img-responsive"><img src="images/logo-small-2.png" alt="" title=""></a>
                </div>
	...
	<section class="news-section news-page red">
		<div class="auto-container">
			<div class="row clearfix">
				...
				<!-- News Block -->
				<div class="news-block col-lg-6 col-md-12 col-sm-12">
					<div class="inner-box wow fadeInUp animated" data-wow-delay="1200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInUp;">
						<div class="row clearfix">
							<!-- Image Column -->
							<div class="image-column col-lg-6 col-md-6 col-sm-12">
								<div class="inner-column">
				...
				<!-- News Block -->
				<div class="news-block col-lg-6 col-md-12 col-sm-12">
					<div class="inner-box wow fadeInUp animated" data-wow-delay="1500ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 600ms; animation-name: fadeInUp;">
						<div class="row clearfix">
							<!-- Image Column -->
							<div class="image-column col-lg-6 col-md-6 col-sm-12">
								<div class="inner-column">
									...
									<?php
											if(isset($_POST['submit'])){
												...
												window.location = "blog.php";
													...
													$sql = "insert into `blog`(email) values ('$new_email')";
