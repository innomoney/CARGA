...
<!-- Mirrored from nauthemes.net/html/carga/testimonials.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 May 2022 14:22:12 GMT -->
<head>
<meta charset="utf-8">
<title>Carga HTML Template | Testimonials</title>
<!-- Stylesheets -->
				...
				<div class="header-upper">
					...
					<div class="clearfix">
						...
						<div class="pull-left logo-box">
							<div class="logo"><a href="testimonials.php"><img src="images/logo-2.png" alt="" title=""></a></div>
						</div>
        ...
        <div class="sticky-header">
        	<div class="auto-container clearfix">
            	...
            	<div class="logo pull-left">
                	<a href="testimonials.php" class="img-responsive"><img src="images/logo-small-2.png" alt="" title=""></a>
                </div>
										...
										<?php
											if(isset($_POST['submit'])){
												...
												window.location = "testimonials.php";
													...
													$sql = "insert into `testimonial`(email) values ('$new_email')";
